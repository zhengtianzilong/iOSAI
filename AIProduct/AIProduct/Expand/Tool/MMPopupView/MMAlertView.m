    ...
    if ( self )
    {
        ...
        if ( title.length > 0 )
        {
            ...
            [self.titleLabel mas_makeConstraints:^(MASConstraintMaker *make) {
                make.top.equalTo(lastAttribute).offset(AdaptedHeight(50));
        ...
        if ( self.inputHandler )
        {
            ...
            self.inputView.textColor = config.textFieldTextColor;
        ...
        for ( NSInteger i = 0 ; i < items.count; ++i )
        {
            ...
            btn.titleLabel.font = (item==items.lastObject)?config.buttonFont:config.buttonFont;
        }
...
- (instancetype)init
{
    ...
    if ( self )
    {
        ...
        self.textFieldTextColor = [UIColor lightGrayColor];
    }
