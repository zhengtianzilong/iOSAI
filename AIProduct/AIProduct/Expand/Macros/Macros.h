...
#define AdaptedWidth(x)  ceilf((x)/2.0 * kScreenWidthRatio)
#define AdaptedHeight(x) ceilf((x)/2.0 * kScreenHeightRatio)
//中文字体iOS8适应
#define AdaptedFontSize(R)     CHINESE_SYSTEM(AdaptedWidth(R))
// 中文字体粗体适应
#define AdaptedFontBoldSize(R)     CHINESE_SYSTEMBold(AdaptedWidth(R))
...
// 导航栏背景色
#define KNavBarBG_color_blue 0x11ccf9
