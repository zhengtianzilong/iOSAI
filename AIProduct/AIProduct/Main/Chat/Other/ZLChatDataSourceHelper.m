...
@implementation ZLChatDataSourceHelper

+ (ZLMessageModel *)getTextMessage:(BOOL)isSender
{
    NSArray *textArray  = @[
    ...
    ZLMessageModel *textMessage = [ZLTextMessageModel text:textArray[arc4random_uniform(4)]  username:@"qyu" timeStamp:[NSDate date:[NSDate date] WithFormate:KDateFormate] isSender:isSender];
    ...
    if (isSender) {
        ...
        ZLMessageServiceModel *imMessage = [[ZLMessageServiceModel alloc]init];
        imMessage.from = @"joy";
        imMessage.to = @"lucy";
...
+ (ZLMessageModel *)getPhotoMessage:(BOOL)isSender
{
    ZLMessageModel *photoMessage = [ZLPhotoMessageModel Photo:nil thumbnailUrl:@"" originPhotoUrl:@"" username:@"joy" timeStamp:[NSDate date:[NSDate date] WithFormate:KDateFormate] isSender:isSender];
...
+ (ZLMessageModel *)getVideoMessage:(BOOL)isSender
{
    
    ZLMessageModel *videoMessage = [ZLVideoMessageModel VideoThumbPhoto:nil videoThumbUrl:nil videoUrl:nil username:nil timeStamp:[NSDate date:[NSDate date] WithFormate:KDateFormate] isSender:isSender];
...
+ (ZLMessageModel *)getVoiceMessage:(BOOL)isSender
{
    ZLVoiceMessageModel *voiceMessage = [ZLVoiceMessageModel VoicePath:nil voiceUrl:nil voiceDuration:nil username:nil timeStamp:[NSDate date:[NSDate date] WithFormate:KDateFormate] isSender:isSender];
...
+ (ZLMessageModel *)getlocationsMessage:(BOOL)isSender
{
    ZLMessageModel *localPositionMessage = [LocationMessageModel LocalPositionPhoto:[[NSBundle
                                                                                      
                                                                                      
                                                                                      bundle:BundleName]pathForResource:@"chat_location_preview@2x" ofType:@"png"] address:@"" location:nil username:nil timeStamp:[NSDate date:[NSDate date] WithFormate:KDateFormate] isSender:isSender];
