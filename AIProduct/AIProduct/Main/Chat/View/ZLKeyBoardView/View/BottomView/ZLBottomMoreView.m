...
#define  KColumNum 4
#define  KRowNum 2
@interface ZLBottomMoreView ()
@property(nonatomic,strong) UIScrollView *scrollview;
@property(nonatomic,strong) UIPageControl *pageControl;
@end

@implementation ZLBottomMoreView
...
- (void)setUpUi
{
    ...
    for (int i = 0; i<titleArray.count; i++) {
        ...
        ZLMoreViewBtn *btn = [[ZLMoreViewBtn alloc]init];
...
- (void)layoutSubviews
{
    ...
    for (int i = 0; i<titleArray.count; i++) {
        ...
        ZLMoreViewBtn *btn = self.scrollview.subviews[i];
    ...
    self.pageControl.frame = CGRectMake(self.width/2, self.height-15, 10, 10);
