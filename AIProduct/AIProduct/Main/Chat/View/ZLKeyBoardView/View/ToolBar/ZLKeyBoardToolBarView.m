...
@interface ZLKeyBoardToolBarView ()<VoiceReordingDelegate,TextInputDelegate,UITextViewDelegate>
@property(nonatomic,assign) CGFloat textHeight;

@property(nonatomic,assign)NSInteger selectBtnIndex;
@end

@implementation ZLKeyBoardToolBarView
...
- (void)setUpUi
{
    ...
    // 文字输入框
    self.textView = [[ZLMessageInputView  alloc] init];
    ...
    //录音
    self.recordBtn = [[ZLVoiceRecordBtn alloc] init];
...
- (void)layoutSubviews
{
    ...
    self.emoijBtn.frame = CGRectMake(CGRectGetMinX(self.moreBtn.frame)-kHorizontalPadding-KTextHeight, self.height-kVerticalPadding-KTextHeight, KTextHeight, KTextHeight);
    
    
    
    self.recordBtn.frame = CGRectMake(CGRectGetMaxX(self.switchBtn.frame)+kHorizontalPadding, self.height-kVerticalPadding-KTextHeight, CGRectGetMinX(self.emoijBtn.frame)-CGRectGetMaxX(self.switchBtn.frame)-2*kHorizontalPadding, self.height-2*kVerticalPadding);
    
    
    self.textView.frame = CGRectMake(CGRectGetMaxX(self.switchBtn.frame)+kHorizontalPadding, self.height-kVerticalPadding-(self.textHeight), CGRectGetMinX(self.emoijBtn.frame)-CGRectGetMaxX(self.switchBtn.frame)-2*kHorizontalPadding, self.height-2*kVerticalPadding);
