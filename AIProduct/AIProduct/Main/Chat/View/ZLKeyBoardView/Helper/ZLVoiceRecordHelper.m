...
static ZLVoiceRecordHelper *audioRecorderUtil = nil;

@interface ZLVoiceRecordHelper () <AVAudioRecorderDelegate> {
    NSTimer *_timer;
...
@implementation ZLVoiceRecordHelper
